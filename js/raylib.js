export const RL_ConfigFlags = Object.freeze({
...
export const RL_TextureFilter = Object.freeze({
...
export const RL_TextureWrap = Object.freeze({
...
export const RL_KeyboardKey = Object.freeze({
...
// Mouse buttons
export const RL_MouseButton = Object.freeze({
...
export function RL_DrawCircle(center, radius, color) {
...
export function RL_DrawCenterText(font, text, ratio_x, ratio_y, font_size, color) {
    ...
    const position = {
        x: SCREEN_SIZE * ratio_x - (text_size.x * ratio_x),
        y: SCREEN_SIZE * ratio_y - (text_size.y * ratio_y)
    };
