const TitleState = {
    ...
    textIsClicked() {
        ...
        ) && RL_IsMouseButtonPressed(RL_MouseButton.MOUSE_BUTTON_LEFT);
    },
    ...
    draw() {
        ...
        const title_text_info = RL_DrawCenterText(TITLE_FONT, "Hexzard", 0.5, 0.45, 256, this.title_color);
        ...
        const result = RL_DrawCenterText(MAIN_FONT, "Click me to start", 0.5 + (Math.cos(TIMER * 4) * 0.02), (Math.sin(TIMER) * 0.008) + 0.75, 64, [255,255,255]);
